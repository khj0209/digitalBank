...
XRPL(XRP Ledger)의 **Credential**과 **MPToken** 기능을 활용한 **커스터디얼 지갑(Custodial Wallet)** 프로젝트입니다.  
사용자의 **KYC(본인 인증)** 절차를 XRPL에 기록하고, 안전하게 토큰을 발행 및 관리할 수 있는 시스템을 구축했습니다.

---

## 📽️ 데모 영상

👉 **[데모 영상 링크](오디오 포함 영상 링크)**
